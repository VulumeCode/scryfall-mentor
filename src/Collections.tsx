...
import { ControlledTreeEnvironment, StaticTreeDataProvider, Tree, TreeRef, TreeItemIndex, TreeItem, UncontrolledTreeEnvironment, TreeEnvironmentRef } from 'react-complex-tree';
...
const Collections: React.FC<{
    ...
    const dataProvider = new StaticTreeDataProvider(treeData, (item, newName) => ({ ...item, data: { ...item.data, title: newName } }));
            ...
            <span style={{ display: 'flex', width: '100%' }}>
                <button className='blueprint-icons-big button-n inverted'
                    onClick={async () => {
                        ...
                        await dataProvider.onChangeItemChildren("root", [...treeData.root.children!, newIndex])
